...
training_group.add_argument('--buffer_aug_type', type=str, choices=['se2', 'so2', 't', 'dqn_c4', 'cn_vec', 'shift', 'crop'], default='cn')
training_group.add_argument('--aug_type', type=str, choices=['se2', 'so2', 't', 'dqn_c4', 'cn_vec', 'shift', 'crop'], default='cn')
