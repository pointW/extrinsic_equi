...
@SUITE.add("benchmarking")
def hard_no_grid(time_limit=_DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
    """Returns reacher with sparse reward with 1e-2 tol and randomized target with no grid."""
    physics = Physics.from_xml_string(
        common.read_model("reacher_no_grid.xml"), common.ASSETS
    )
    task = Reacher(target_size=_SMALL_TARGET, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
...
@SUITE.add("benchmarking")
def hard_tilt_camera1(
    time_limit=_DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None
):
    """Returns reacher with sparse reward with 1e-2 tol and randomized target with tilted camera angle."""
    physics = Physics.from_xml_string(
        common.read_model("reacher_tilt_camera1.xml"), common.ASSETS
    )
    task = Reacher(target_size=_SMALL_TARGET, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
...
@SUITE.add("benchmarking")
def hard_tilt_camera2(
    time_limit=_DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None
):
    """Returns reacher with sparse reward with 1e-2 tol and randomized target with tilted camera angle."""
    physics = Physics.from_xml_string(
        common.read_model("reacher_tilt_camera2.xml"), common.ASSETS
    )
    task = Reacher(target_size=_SMALL_TARGET, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
...
@SUITE.add("benchmarking")
def hard_tilt_camera3(
    time_limit=_DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None
):
    """Returns reacher with sparse reward with 1e-2 tol and randomized target with tilted camera angle."""
    physics = Physics.from_xml_string(
        common.read_model("reacher_tilt_camera3.xml"), common.ASSETS
    )
    task = Reacher(target_size=_SMALL_TARGET, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
...
@SUITE.add("benchmarking")
def hard_tilt_camera4(
    time_limit=_DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None
):
    """Returns reacher with sparse reward with 1e-2 tol and randomized target with tilted camera angle."""
    physics = Physics.from_xml_string(
        common.read_model("reacher_tilt_camera4.xml"), common.ASSETS
    )
    task = Reacher(target_size=_SMALL_TARGET, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
