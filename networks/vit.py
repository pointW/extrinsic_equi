...
from networks.vit_layers import to_2tuple, trunc_normal_, lecun_normal_
...
if __name__ == '__main__':
    model = VisionTransformer(img_size=96, patch_size=8, in_chans=9, embed_dim=128, depth=4, num_heads=8, mlp_ratio=1.,
                              qkv_bias=False)
    print(1)